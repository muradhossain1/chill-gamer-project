...
const Benefits = () => {
    return (
        <div>
            <h2 className="text-3xl md:text-4xl text-center font-bold mt-12">Chill gamer benefits Section</h2>
            <div className="border p-6 md:w-2/3 mx-auto rounded-xl my-10 bg-gray-200 ">
